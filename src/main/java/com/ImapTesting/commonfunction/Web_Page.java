...
public class Web_Page extends Baseclass 
{
...
>>>>>>> master
	 ...
	 */
	public static Boolean searchTextOnWebPage(WebDriver driver, String textToSearch) throws NoSuchElementException, ElementNotVisibleException{
	...
	public static void waitForPageLoad(WebDriver driver)
	{
	    ...
	    wait.until(new Function<WebDriver, Boolean>() 
	    {
	        ...
	        {
                System.out.println("Current Window State: " + String.valueOf(((JavascriptExecutor) driver_).executeScript("return document.readyState")));
	            return String.valueOf(((JavascriptExecutor) driver_).executeScript("return document.readyState")).equals("complete");
	        }
	    });
	}
